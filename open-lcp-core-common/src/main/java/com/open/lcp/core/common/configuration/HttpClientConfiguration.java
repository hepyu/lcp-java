package com.open.lcp.core.common.configuration;
...
public class HttpClientConfiguration {
	...
	private static final Log logger = LogFactory.getLog(HttpClientConfiguration.class);
			...
			try {
				while (!shutdown) {
					synchronized (lock) {
						...
						// System.out.println("close idle conn................");
					}
				}
