...
public interface CommentHbaseDAO {
	...
	boolean addComment(int appId, int typeId, String tid, long cid,
	...
	boolean addCheckNoPassComments(int typeId,
            List<CommentCheckColumn> commentColumns) throws IOException;

	boolean addCheckPassComments(int typeId, List<CommentCheckColumn> commentColumns)
			throws IOException;

	boolean addReviewComments(int typeId, List<CommentCheckColumn> commentColumns)
			throws IOException;
    ...
    boolean addAIPassComments(int typeId, List<CommentCheckColumn> commentColumns) throws IOException;

    List<CommentCheckColumn> listCommentPass(int typeId, long startCid, int len);
}
