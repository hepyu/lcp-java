...
public class PassportApiException extends Exception {
	...
	public PassportApiException(int passportCode) {
		super(passportCode + "");
		this.passportCode = passportCode;
	}

	public PassportApiException(int passportCode, Exception e) {
		super(passportCode + "", e);
		this.passportCode = passportCode;
	}

	public PassportApiException(int passportCode, String msg, Exception e) {
		super(msg, e);
		this.passportCode = passportCode;
	}
