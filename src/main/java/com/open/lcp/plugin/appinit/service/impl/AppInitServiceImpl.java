package com.open.lcp.plugin.appinit.service.impl;
...
import com.open.lcp.plugin.appinit.service.dao.AppInitInfoDAO;
...
public class AppInitServiceImpl implements AppInitService {
	...
	private RedisX redis = RedisXFactory.loadRedisX(ResourceEnum.redis_lcp_plugin_app_init.resourceName());
